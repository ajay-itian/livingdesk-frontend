...
import { API_BASE, fetchWithApiKey } from "@/config/API";
          ...
          <div className="bg-card rounded-2xl shadow-soft border border-border p-6 md:p-8 animate-scale-in">
            <Form {...form}>
              <BookingForm
                ...
                setSelectedTimeSlots={setSelectedTimeSlots} selectedTimeSlots={[]} disabledSlots={[]} loadingAvailability={false}              />
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="mt-6">
                <Button
                  type="submit"
                  className={`inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 bg-primary text-primary-foreground h-10 px-4 py-2 w-full ${NO_HOVER}`}
                  size="lg"
