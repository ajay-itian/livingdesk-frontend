                ...
                <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
                    ...
                    <div className="relative max-w-4xl mx-auto text-center z-10">
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-teal-600 tracking-tight mb-6 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
                            Workspaces Designed for <span className="text-teal-600 relative whitespace-nowrap">
                                Success
    ...
    return (
        ...
        >
            ...
            <div className="p-6 flex-1 flex flex-col">
                <div className="mb-4">
                    <h3 className="text-xl font-bold text-teal-900 group-hover:text-teal-600 transition-colors mb-2">
                        {location.name}
                    </h3>
